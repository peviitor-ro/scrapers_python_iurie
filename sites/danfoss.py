...
def scraper():
    ...
    soup = GetStaticSoup("https://jobs.danfoss.com/search/?searchby=location&createNewAlert=false&q=&locationsearch=Romania&geolocation=&optionsFacetsDD_department=&optionsFacetsDD_facility=")
