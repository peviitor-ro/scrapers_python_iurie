...
def scraper():
    ...
    """
    job_list = []
    url = "https://partnerd.teamtailor.com/jobs?page=1&query=&split_view=true"
    ...
    while True:
        ...
        if soup.find("div", id="show_more_button"):
            url  = "https://partnerd.teamtailor.com/jobs?page=2&query=&split_view=true"
        else:
            break
